...
export default class VaultExplorerSettingsTab extends PluginSettingTab {
	...
	display(): void {
		...
		new Setting(containerEl)
			...
			.setDesc("When enabled, time values will update every minute. This will cause a refresh of the Vault Explorer view. When disabled, time values will only update when the view is reopened.")
