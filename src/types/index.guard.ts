...
export function isVaultExplorerPluginSettings(
	obj: unknown
): obj is VaultExplorerPluginSettings {
	...
	return (
		...
		(typedObj["filters"]["timestamp"]["value"] === "created-today" ||
			...
			typedObj["filters"]["timestamp"]["value"] ===
				"modified-this-week" ||
		...
		typedObj["filters"]["custom"]["groups"].every(
			(e: any) =>
					...
					(e: any) =>
						(((e !== null && typeof e === "object") ||
							...
							(e["condition"] === TextFilterCondition.IS ||
								...
								e["condition"] ===
									TextFilterCondition.DOES_NOT_EXIST ||
								e["condition"] ===
								...
								e["condition"] ===
									NumberFilterCondition.EXISTS ||
								e["condition"] ===
									NumberFilterCondition.DOES_NOT_EXIST ||
								...
								e["condition"] ===
									DateFilterCondition.IS_ON_OR_BEFORE ||
								e["condition"] ===
									DateFilterCondition.IS_ON_OR_AFTER ||
								e["condition"] === DateFilterCondition.EXISTS ||
								e["condition"] ===
									DateFilterCondition.DOES_NOT_EXIST ||
								e["condition"] === CheckboxFilterCondition.IS ||
								e["condition"] ===
									CheckboxFilterCondition.IS_NOT ||
								e["condition"] ===
									CheckboxFilterCondition.EXISTS ||
								e["condition"] ===
									CheckboxFilterCondition.DOES_NOT_EXIST ||
								e["condition"] ===
									ListFilterCondition.CONTAINS ||
								e["condition"] ===
									ListFilterCondition.DOES_NOT_CONTAIN ||
								e["condition"] === ListFilterCondition.EXISTS ||
								e["condition"] ===
									ListFilterCondition.DOES_NOT_EXIST ||
								e["condition"] ===
									ContentFilterCondition.CONTAINS ||
								e["condition"] ===
									ContentFilterCondition.DOES_NOT_CONTAIN ||
								e["condition"] ===
									ContentFilterCondition.IS_EMPTY ||
								e["condition"] ===
									ContentFilterCondition.IS_NOT_EMPTY ||
								e["condition"] === FolderFilterCondition.IS ||
								e["condition"] ===
									FolderFilterCondition.IS_NOT ||
								e["condition"] === FileNameFilterCondition.IS ||
								e["condition"] ===
									FileNameFilterCondition.IS_NOT ||
								e["condition"] ===
									FileNameFilterCondition.CONTAINS ||
								e["condition"] ===
									FileNameFilterCondition.DOES_NOT_CONTAIN ||
								e["condition"] ===
									FileNameFilterCondition.STARTS_WITH ||
								e["condition"] ===
									FileNameFilterCondition.ENDS_WITH) &&
		...
		typeof typedObj["views"]["grid"]["loadSocialMediaImage"] ===
			"boolean" &&
		...
		typeof typedObj["views"]["feed"]["collapseContent"] === "boolean" &&
